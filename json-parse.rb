...
# Dirty hack, but this needed to be done, not reusable.
# This should be set to the number of days that the stats being crunched span.
number_days = 7
...
CSV.open("calculatedOutput.csv", "wb") do |csv|
	csv << csvHeaders
